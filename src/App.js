  ...
  return (
    ...
    <div className='content'>
      <div className='content__wrap'>   
        ...
        <input onChange={(event) => {setTask({id: Math.random().toString(), title: event.target.value})}} className='content__text' placeholder='Write your task...' value={task.title}></input>
